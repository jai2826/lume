        ...
        <div className="max-w-md w-full glass-panel p-8 rounded-xl border border-white/10 text-left">
          <div className="flex gap-4 mb-8 border-b border-white/10 pb-2">
            <button
              ...
              className={`pb-2 text-lg font-bold transition-colors ${mode === "create" ? "text-white border-b-2 border-white" : "text-gray-500 hover:text-gray-300"}`}>
              Create Studio
            </button>
            <button
              onClick={() => setMode("join")}
              className={`pb-2 text-lg font-bold transition-colors ${mode === "join" ? "text-white border-b-2 border-white" : "text-gray-500 hover:text-gray-300"}`}>
              Join Studio
            </button>
          </div>
          ...
          {mode === "create" ? (
            <div className="space-y-4 mb-6">
              <p className="text-muted-foreground text-sm mb-4">
                Create a new command center for your brand.
              </p>
              <div>
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  <span className="bg-black/80 border border-white/20 border-r-0 rounded-l-md px-3 py-2 text-gray-500 text-sm h-10 flex items-center">
                    lume.com/
                  </span>
                  <Input
                    value={slug}
            ...
            <div className="space-y-4 mb-6">
              <p className="text-muted-foreground text-sm mb-4">
                Enter the 10-character invite code provided
                by your Admin.
              </p>
              <div>
                <label className="text-sm font-medium text-gray-300 ml-1">
              ...
              <Button
                ...
                disabled={loading}
                className="w-full font-bold mt-4 bg-white text-black hover:bg-gray-200">
