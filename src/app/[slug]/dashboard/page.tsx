  ...
  return (
    <div className="p-12">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-5xl font-bold tracking-tight">Studio Dashboard</h1>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="h-64 rounded-2xl border border-black/5 bg-card shadow-sm p-8">
             <h3 className="text-xl font-semibold text-foreground">Recent Shots</h3>
          </div>
          <div className="h-64 rounded-2xl border border-black/5 bg-card shadow-sm p-8">
             <h3 className="text-xl font-semibold text-foreground">Engagement</h3>
          </div>
          <div className="h-64 rounded-2xl border border-black/5 bg-card shadow-sm p-8">
             <h3 className="text-xl font-semibold text-foreground">Active Platforms</h3>
          </div>
        </div>
      </div>
    </div>
